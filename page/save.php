<?php
    ...
    try {
        ...
        elseif ($donner=="michemin") {
            ...
            $michemin=$michemin+1;
            $total=$total+1;
            $requette="UPDATE `alluser` SET `michemin` = $michemin,,`total`, = $total WHERE `alluser`.`id` = 1;";
        }
        ...
        elseif ($donner=="offline") {
            $online=$online-1;
            $requette="UPDATE `alluser` SET `online` = $online WHERE `alluser`.`id` = 1;";
        }
